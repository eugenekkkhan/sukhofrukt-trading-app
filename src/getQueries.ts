...
const verifyID = async (id: string) => {
  return await axios.get(
    import.meta.env.VITE_BASE_URL + apiUrl + "public/verifyID",
    {
      params: { id: id },
...
const fetchHistory = async (id: string) => {
  return await axios.get(
    import.meta.env.VITE_BASE_URL + apiUrl + "private/fetchHistory",
    {
      params: { id: id },
    },
  );
...
const fetchPositions = async (id: string) => {
  return await axios.get(
    import.meta.env.VITE_BASE_URL + apiUrl + "private/fetchPositions",
    {
      params: { id: id },
    },
  );
